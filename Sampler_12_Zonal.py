...
# Trajectory C: Zonal Sectioning [=]
trajectory = {'datetime': [dt.datetime(2003, 9, 5, 0, 0, 0)],
              'lon': [-107.825], 'lat': [14]}
##                          spd  hours direction   attach to this trajectory
trajectory = calc_trajectory(1.25, 144, 0.0, prev_trajectory=trajectory)
trajectory = calc_trajectory(1.25, 144, 180.0, prev_trajectory=trajectory)
